...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Warren Buffet predicts Bitcoin collapse. really no mate";
...
//         printf("genesis.GetHash = %s\n", genesis.GetHash().ToString().c_str());
  //       printf("merkle = %s\n", genesis.hashMerkleRoot.ToString().c_str());
        ...
        assert(hashGenesisBlock == uint256("0xeb69289107e6067a7a87eacd5dd8bbc82748d20636173ed36af22a6d43c912bc"));
        assert(genesis.hashMerkleRoot == uint256("0x73d9b9935b57cde8c8f75b7f8b770515cffa2cf5f147e6933e495ed219af82ed"));
        ...
        vSeeds.push_back(CDNSSeedData("0",  "45.77.78.72"));
        vSeeds.push_back(CDNSSeedData("1",  "104.207.129.122"));
